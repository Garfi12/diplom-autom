...
class UpdateCartAPI:
    """
                    Класс для работы с API обновления корзины
    ...
    def __init__(self, url):
        ...
        self.headers = {
            ...
            # Установка типа содержимого для JSON
            'Authorization': bearer_token
            # Авторизационный токен для доступа к API
        }
    ...
    def update_cart(self, items: dict) -> tuple:
        """
                    Отправляет PUT-запрос для редактирования корзины.
                        ...
                        :param items: Словарь с товарами и
                        их количеством для обновления корзины.
                         Пример формата:
                      {
                          "items": [
                              {"id": 1, "quantity": 2},
                    ...
                    :return: Кортеж, содержащий статус-код ответа
                    (int) и текст ответа от сервера (str).
        """
